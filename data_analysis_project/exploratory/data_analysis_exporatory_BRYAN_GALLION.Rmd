...
```
14. Househang Kaveh, MD and David M. Gejer, DDS received shipments every year except 2012. What do the shipment rates over the years look like to these practitioners? Did they get in trouble?
```{r}
...
15. Summarize the shipments to the Kensington zip code. What valuable information does this summary yield?
```{r}
